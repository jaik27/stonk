...
# --- PATCH: Add filter to suppress "Max Symbol Limit Reached" messages ---
class IgnoreMaxSymbolLimit(logging.Filter):
    def filter(self, record):
        return "Max Symbol Limit Reached" not in record.getMessage()

sclogger.addFilter(IgnoreMaxSymbolLimit())
# --- END PATCH ---
